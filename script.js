function outDate() {
    ...
    let yaersVS = nowDate.diff(startVS, 'year')
        let yearToMonth = yaersVS * 12
        let differentMonth = monthsVS - yearToMonth
        let rightYear = `${yaersVS}.${differentMonth}`
    ...
    document.getElementById('yaersVS').innerHTML = `${rightYear} years`;
